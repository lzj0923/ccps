...
export default {
  data() {
    ...
    return {
      ...
      adminSyncMetrics: null,
      adminSyncExportHeaders: [],
      adminSyncExportRows: [],
      ...
      adminSyncCreateNonce: 0,
      adminSyncRefreshNonce: 0,
      ...
      alertItems: [
        { title: "房款即將到期", detail: "Pavilion Square A-28-05，2026-05-15 前完成付款。", status: "待處理" },
        { title: "租金未收提醒", detail: "CCP Residence B-12-07，本月租金尚未確認。", status: "待確認" },
        { title: "維修費用待確認", detail: "水電維修 RM 38,450.00，需財務確認。", status: "待處理" },
        { title: "SQL 同步失敗", detail: "2 筆同步失敗，請查看 SQL 同步記錄。", status: "逾期" }
      ],
