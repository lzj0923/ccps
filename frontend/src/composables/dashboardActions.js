...
export default {
  methods: {
    ...
    triggerPrimaryAction() {
      ...
      if (this.currentId === 'adminSync') { this.adminSyncCreateNonce += 1; return; }
    ...
    triggerSecondaryAction() {
      ...
      if (this.currentId === 'adminSync') { this.adminSyncRefreshNonce += 1; return; }
    ...
    exportCsv() {
      ...
      if (this.currentId === 'adminSync' && this.adminSyncExportHeaders?.length) { downloadCsv('adminSync-export.csv', this.adminSyncExportHeaders, this.adminSyncExportRows || []); this.showToast('CSV 已匯出'); return; }
