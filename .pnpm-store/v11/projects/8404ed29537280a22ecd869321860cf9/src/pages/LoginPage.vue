...
export default {
  ...
  computed: {
    ...
    usernameLabel() { return this.$t('login.username'); }, passwordLabel() { return this.$t('login.password'); },
    usernamePlaceholder() { return this.$t('login.usernamePlaceholder'); }, passwordPlaceholder() { return this.$t('login.passwordPlaceholder'); },
