...
public interface AdminPropertyCashflowMapper {
    String ROW_COLUMNS = "ce.id,fr.id AS financeRecordId,fr.transaction_no AS transactionNo,ce.direction,ce.category,"
            + "ce.description,fr.amount,fr.currency,ce.occurred_on AS occurredOn,fr.payment_method AS paymentMethod,"
            ...
            + "COALESCE(cu.display_name,cu.username,'系統') AS createdByName,fr.created_at AS createdAt,fr.updated_at AS updatedAt";
    ...
    @Insert("INSERT INTO cashflow_entries (finance_record_id,unit_id,owner_id,direction,category,description,occurred_on,attachment_status) "
            + "VALUES (#{financeRecordId},#{unitId},#{ownerId},#{direction},#{category},#{description},#{occurredOn},#{attachmentStatus})")
    @Options(useGeneratedKeys=true,keyProperty="id")
    ...
    @Update("UPDATE cashflow_entries SET direction=#{direction},category=#{category},description=#{description},occurred_on=#{occurredOn},attachment_status=#{attachmentStatus} WHERE id=#{id}")
    ...
    class CashflowWriteRow {private Long id,financeRecordId,unitId,ownerId;private String direction,category,description,attachmentStatus;private LocalDate occurredOn;public Long getId(){return id;}public void setId(Long v){id=v;}public Long getFinanceRecordId(){return financeRecordId;}public void setFinanceRecordId(Long v){financeRecordId=v;}public Long getUnitId(){return unitId;}public void setUnitId(Long v){unitId=v;}public Long getOwnerId(){return ownerId;}public void setOwnerId(Long v){ownerId=v;}public String getDirection(){return direction;}public void setDirection(String v){direction=v;}public String getCategory(){return category;}public void setCategory(String v){category=v;}public String getDescription(){return description;}public void setDescription(String v){description=v;}public String getAttachmentStatus(){return attachmentStatus;}public void setAttachmentStatus(String v){attachmentStatus=v;}public LocalDate getOccurredOn(){return occurredOn;}public void setOccurredOn(LocalDate v){occurredOn=v;}}
